...
class BaseOptions():
    ...
    def initialize(self, parser, name):
        ...
        parser.add_argument('--no_dropout', default=0.8, action='store_true', help='no dropout for the generator')
        # dataset parameters
    ...
    def gather_options(self, name):
        ...
        if not self.initialized:  # check if it has been initialized
            ...
            parser = self.initialize(parser, name)
